...
VALUES ('Atilla hesap', 'TRY', TRUE, TRUE, 5000.00, 5000.00, 1, CURRENT_TIMESTAMP,0 ),
       ('admin hesap', 'TRY', TRUE, TRUE, 200.00, 200.00, 2, CURRENT_TIMESTAMP,0 ),
       ('osman hesap', 'TRY', FALSE, FALSE, 3000.00, 3000.00, 3, CURRENT_TIMESTAMP,0 ),
       ('osman hesap1', 'TRY', FALSE, TRUE, 2000.00, 2000.00, 3, CURRENT_TIMESTAMP,0 ),
       ('osman hesap2', 'TRY', TRUE, FALSE, 1000.00, 1000.00, 3, CURRENT_TIMESTAMP,0 );